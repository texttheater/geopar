...
class ItemsTestCase(unittest.TestCase):
    ...
    def test_items_example1_skip_shift(self):
        ...
        self.assertTrue(item.stack[0].equivalent(terms.from_string('capital(_, _)')))
        self.assertTrue(item.stack[1].equivalent(terms.from_string('answer(_, _)')))
    ...
    def test_items_example1_full(self):
        ...
        self.assertTrue(item.stack.head.equivalent(terms.from_string(
